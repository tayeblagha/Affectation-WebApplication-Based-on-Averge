...
return ResponseEntity.ok(response);
	...
	@DeleteMapping("/AllprojectDel")
	@Transactional
	public ResponseEntity<Map<String, Boolean>> deleteAllProject(){
...
return ResponseEntity.ok(response);
    ...
    @DeleteMapping("/AllstudentDel")
    public ResponseEntity<Map<String, Boolean>> deleteAllStudent(){
